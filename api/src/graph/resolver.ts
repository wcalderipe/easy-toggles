...
const application = async (source: any, { id }: any, { store }: Context): Promise<Application> => {
  try {
...
const deleteApplication = async (source: any, { id }: any, { store }: Context): Promise<boolean> => {
  try {
...
const createApplication = async (source: any, { input }: any, { store }: Context): Promise<Application> =>
  await saveApplication(input, store)

const updateApplication = async (source: any, { id, input }: any, { store }: Context): Promise<Application> => {
  try {
